...
panels use $B_{\mathrm{out}} = 50$ outer draws, $N_{\mathrm{sim}}^{\mathrm{in}} = 20$
...
contracts roughly as $1/\sqrt{n_{\mathrm{pilot}}}$, as expected for a
nonparametric bootstrap whose variance scales with the pilot's effective
sample size.
