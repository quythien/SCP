...
nominal level $\alpha$ across all $G$ genes; genes passing the threshold are
declared rhythmic ($D_{g,s}=1$).

\emph{Step 4 --- Power aggregation.}
Average empirical power and FDR estimates across $S$ replicates to obtain
stable design-level summaries.
