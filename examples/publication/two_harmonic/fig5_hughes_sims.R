#!/usr/bin/env Rscript
# =============================================================================
# Fig 5 Hughes 2009 sims (K=2 mouse liver) - both paired and unpaired modes
#
# Produces two RDS files for the Hughes 2009 mouse liver pilot:
#   - fig5_panelA_Hughes_paired.rds   (Panel A source, paired)
#   - fig5_panelAB_Hughes_unpaired.rds (Panel B source, unpaired)
# =============================================================================
...
RES_PATH_PAIRED  <- "output/two_harmonic/results/fig5_panelA_Hughes_paired.rds"
RES_PATH_UNPAIR  <- "output/two_harmonic/results/fig5_panelAB_Hughes_unpaired.rds"
...
run_grid <- function(paired_sigma, out_path) {
  cat(sprintf("\n== Running Hughes K=2 sims (paired_sigma=%s) ==\n", paired_sigma))
  t0 <- Sys.time()
...
run_grid(paired_sigma = TRUE,  RES_PATH_PAIRED)
run_grid(paired_sigma = FALSE, RES_PATH_UNPAIR)
cat("\n== Done ==\n")
