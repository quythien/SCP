...
#'     C-E from fig6_differential_Bsweep_fdr20_fine.R (GTEx Adrenal-vs-Liver DR/DP/DM
#'     at BH-FDR 20% on a fine N grid, matching Fig 2; A/B biomarker panels stay at
#'     BH-FDR 5%).
